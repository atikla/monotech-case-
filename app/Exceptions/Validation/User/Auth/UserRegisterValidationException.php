...
class UserRegisterValidationException extends BaseValidationException
{
    /**
     * @return string
     */
    ...
    {
        return Str::upperSnake(Response::$statusTexts[Response::HTTP_UNPROCESSABLE_ENTITY] . ' USER_REGISTER');
    }
}
